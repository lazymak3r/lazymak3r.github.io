        ...
        <>
            ...
            >
                <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 top-6 z-10">
                    <div
                        className="w-4 h-4 rounded-full bg-brand-violet border-2 border-bg-deep shadow-[0_0_12px_rgba(72,18,228,0.6)]"/>
                </div>
            ...
            {modalProject && (
                <StoreLinksModal project={modalProject} onClose={() => setModalProject(null)}/>
            )}
        </>
    )
}